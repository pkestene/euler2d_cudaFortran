...
contains
  ...
  subroutine godunov_unsplit_cpu(params, data_in, data_out, dt)
    ...
    call computeAndStoreFluxes(params, dt)
  ...
  subroutine compute_dt(params, dt, useU)
    ...
    if (useU == 0) then
       ...
       do j=ghostWidth+1,params%jsize-ghostWidth-1
          do i=ghostWidth+1,params%isize-ghostWidth-1
  ...
  !! !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  subroutine computeAndStoreFluxes(params, dt)
  ...
  subroutine updateHydro(params, dataIn, dataOut)
    ...
    do j=ghostWidth+1,params%jsize-ghostWidth
       do i=ghostWidth+1,params%isize-ghostWidth
